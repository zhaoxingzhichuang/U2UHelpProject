...
public interface CustomService {
	...
	EUDataGridResult findltandgtNumGroupByStylecode() throws Exception;

	List<Map<String, Integer>> getTotalShopsaleData();

	Map<String, Integer> getTotalShopsaleDataByYear();
}
