...
<div style="padding:10px 10px 10px 10px">
	<form id="roleAddForm" class="roleForm" method="post">
        ...
        <span >权&nbsp限&nbsp:</span><br><br>
			...
			<label><input name="permissionOption2" type="checkbox" value="291" />往年库存新增 </label> 
			<label><input name="permissionOption2" type="checkbox" value="292" />往年库存修改 </label> 
			<label><input name="permissionOption2" type="checkbox" value="293" />往年库存删除 </label> 
			<br><br>
	        <span style="font-weight: bold;">总账登记管理：</span>
			<label><input name="permissionOption2" type="checkbox" value="281" />总账新增 </label> 
			<label><input name="permissionOption2" type="checkbox" value="282" />总账修改 </label> 
			<label><input name="permissionOption2" type="checkbox" value="283" />总账删除 </label> 
			<br><br>
